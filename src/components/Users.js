          ...
          <div style={{ width: '90%', margin: '0 auto' }}>
            <div style={{ width: '100%' }}>
              ...
              >
                ...
                >
                  {!showDeleted ? 'Show inactive users' : 'Hide inactive users'}
                </button>
                      ...
                      {filtersActive.orderActive.active && (
                        <li
                          ...
                          onClick={() => {
                            ...
                            setFiltersActive({
                              ...filtersActive,
                              orderActive: { active: false, by: '', value: '' }
                            })
                          }}
                        >
              ...
              >
                <button
                  style={{
                    backgroundColor:
                      selectedToAuthenticated?.length > 0 ? '#feae00' : '#bbb',
                    padding: '5px 20px',
                    marginBottom: '10px',
                    color:
                      selectedToAuthenticated?.length > 0 ? 'white' : 'black',
                    fontWeight: 'bold'
                  }}
                  onClick={() =>
                ...
                <tbody>
                  {itemsFilter
                    ...
                    .map(user =>
                      ...
                      (user[1].inactive && showDeleted) || !user[1].inactive ? (
                        <tr
                          key={user[0]}
                          style={{
